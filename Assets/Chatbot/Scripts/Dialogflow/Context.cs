...
namespace Dialogflow {
    ...
    public class Context {
        ...
        [JsonProperty] public int LifespanCount { get; set; }
        ...
        public Context(string name, int lifespanCount, Dictionary<string, object> parameters) {
            Name = name;
            LifespanCount = lifespanCount;
            Parameters = parameters;
        }

        public Context(string name, int lifespanCount, params (string, object)[] parameters) {
            Name = name;
            LifespanCount = lifespanCount;
