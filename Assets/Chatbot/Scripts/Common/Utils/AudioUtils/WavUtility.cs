...
namespace ChatBot.Utils.AudioUtils {
    ...
    public class WavUtility {
        ...
        protected const int BlockSize_16Bit = 2;
        ...
        protected static int WriteFileHeader(ref MemoryStream stream, int fileSize) {
            int count = 0;
            int total = 12;
        ...
        protected static int WriteFileFormat(ref MemoryStream stream, int channels, int sampleRate, UInt16 bitDepth) {
            int count = 0;
            int total = 24;
        ...
        protected static int WriteFileData(ref MemoryStream stream, AudioClip audioClip, UInt16 bitDepth) {
            int count = 0;
            int total = 8;
        ...
        protected static byte[] ConvertAudioClipDataToInt16ByteArray(float[] data) {
        ...
        protected static int WriteBytesToMemoryStream(ref MemoryStream stream, byte[] bytes, string tag = "") {
