...
public class OnLookAtRotateByEyeGaze : BaseEyeFocusHandler {
    ...
    [Tooltip(
        "If the angle between 'Gaze to Target' and 'Camera to Target' is less than this value, do nothing. This is to prevent small jittery rotations.")]
    [SerializeField]
    ...
    private void RotateHitTarget() {
        var TargetToHit =
            (gameObject.transform.position - CoreServices.InputSystem.EyeGazeProvider.HitPosition).normalized;
        var TargetToCam = (this.gameObject.transform.position - CameraCache.Main.transform.position).normalized;
